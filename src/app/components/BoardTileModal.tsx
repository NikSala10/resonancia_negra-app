        ...
        <>
          ...
          >
            <div className="w-full max-w-2xl rounded-2xl border border-white/10 bg-[#050B12]/95 p-6">
              <h2 className="text-3xl font-bold text-[#11A1AB] mb-2">
                Casilla del tablero
              </h2>
              ...
              <div className="space-y-3">
                {options.map((option) => (
                  ...
                  >
                    <div className="text-sm uppercase tracking-[0.2em] text-white/35 mb-1">
                      Opción {option.id}
                    </div>
                    <div className="text-xl font-semibold text-[#D9E4F2]">
                      {option.label}
                    </div>
                  </button>
                ))}
              ...
              <button
                onClick={onClose}
                className="mt-5 w-full h-12 rounded-lg border border-white/10 text-white/60 hover:bg-white/5 transition"
              >
                Cerrar
              </button>
            </div>
